...
const CONFIG_ADMIN_CREATE_KEY_MINSIZE = 7;
const CONFIG_ADMIN_CREATE_KEY_MAXSIZE = 21;
const CONFIG_ADMIN_CREATE_VALUE_MINSIZE = 8;
const CONFIG_ADMIN_CREATE_VALUE_MAXSIZE = 22;

const CONFIG_TEMPLATE_TEMPLATENAME_MINSIZE = 9;
const CONFIG_TEMPLATE_TEMPLATENAME_MAXSIZE = 23;
const CONFIG_TEMPLATE_TEMPLATEDESC_MAXSIZE=24;
const CONFIG_TEMPLATE_SECTIONNAME_MINSIZE=10;
const CONFIG_TEMPLATE_SECTIONNAME_MAXSIZE=25;
const CONFIG_TEMPLATE_SECTIONDESC_MAXSIZE=26;
const CONFIG_TEMPLATE_QUESTIONTITLE_MINSIZE=10;
const CONFIG_TEMPLATE_QUESTIONTITLE_MAXSIZE=25;

const CONFIG_CHECKLIST_TEMPLATENAME_MINSIZE=10;
const CONFIG_CHECKLIST_TEMPLATENAME_MAXSIZE=25;
const CONFIG_CHECKLIST_TEMPLATEDESC_MAXSIZE=24;
